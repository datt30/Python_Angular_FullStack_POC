...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-client-client-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsClientDialogBoxDialogBoxComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsClientClientRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ClientRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppComponentsClientClientComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsClientClientComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_models_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var src_app_services_client_client_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/services/client/client.service */
    "./src/app/services/client/client.service.ts");

    var ClientComponent =
    /*#__PURE__*/
    function () {
      function ClientComponent(dialog, clientService) {
      ...
      _createClass(ClientComponent, [{
        ...
        value: function addRowData(row_obj) {
          ...
          this.dataSource.push(client); //for update table rows when changes
        ...
        value: function updateRowData(row_obj) {
          ...
          this.clientService.updateClient(client); //for update table rows when changes
        ...
        value: function deleteRowData(row_obj) {
          ...
          this.clientService.deleteClient(row_obj.identityNumber); //for update table rows when changes
    ...
    ClientComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/components/client/client.component.css")).default]
    })], ClientComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsClientClientModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _client_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./client-routing.module */
    "./src/app/components/client/client-routing.module.ts");
    /* harmony import */


    var _client_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./client.component */
    "./src/app/components/client/client.component.ts");
    /* harmony import */
    ...
    ClientModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_client_component__WEBPACK_IMPORTED_MODULE_4__["ClientComponent"], _dialog_box_dialog_box_component__WEBPACK_IMPORTED_MODULE_6__["DialogBoxComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _client_routing_module__WEBPACK_IMPORTED_MODULE_3__["ClientRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"]],
  ...
  /***/
  function srcAppComponentsClientDialogBoxDialogBoxComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsClientDialogBoxDialogBoxComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    DialogBoxComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/client/dialog-box/dialog-box.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./dialog-box.component.css */
      "./src/app/components/client/dialog-box/dialog-box.component.css")).default]
  ...
  function srcAppModelsClientTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "clientColumns", function () {
      return clientColumns;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "CLIENTS_DATA", function () {
      return CLIENTS_DATA;
    });
    /* harmony import */
    ...
    var clientColumns = ['identityNumber', 'age', 'clientName', 'clientSurname', 'action'];
    var CLIENTS_DATA = [{
  ...
  /***/
  function srcAppServicesClientClientServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(ClientService, [{
        ...
        value: function getAllClients() {
          return this.http.get("".concat(this.url, "/clients/"));
        }
      }, {
        key: "createClient",
        value: function createClient(client) {
          ...
          this.http.post("".concat(this.url, "/client/"), {
        ...
        value: function deleteClient(id) {
          this.http.delete("".concat(this.url, "/client/").concat(id)).subscribe(function (val) {
        ...
        value: function updateClient(client) {
          ...
          this.http.put("".concat(this.url, "/client/").concat(client.identityNumber), {
            "identityNumber": client.identityNumber,
            "age": client.age,
            "clientName": client.clientName,
            "clientSurname": client.clientSurname
...
//# sourceMappingURL=components-client-client-module-es5.js.map